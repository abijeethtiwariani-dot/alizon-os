...
(function () {
  ...
  function html(o){
    ...
    h+='<header class="p-lh">'
      ...
      +'<div class="p-lh-txt">'
        ...
        +'<div class="p-lh-addr">Thiruvananthapuram, Kerala, India&nbsp; ·&nbsp; www.alizongov.com</div>'
    ...
    h+='<footer class="p-foot"><div class="p-foot-rule"></div>'
      ...
      +'Thiruvananthapuram, Kerala&nbsp; ·&nbsp; www.alizongov.com</div></footer>';
    h+='</article>';
    return h;
  }
  ...
  var CSS =
    ...
    +'.alz-pcc.lhp-page{width:210mm;max-width:210mm;padding:14mm 16mm 10mm;box-sizing:border-box}'
