...
(function(){
  ...
  var AUTH_KEYS = ['alizonStudents','alizonHR','alizonFaculty','alizonResults','alizonContent','alizonExamDocs','alizonNews','alizonWorkshops','alizonWsFeedback','alizonPhotos','alizonPrograms','alizonCurriculum','alizonAllotment','alizonHeroCover','alizonVacancies','alizonCareerEvents','alizonCareerPay','alizonCareerRegs','alizonLabAccess'];
