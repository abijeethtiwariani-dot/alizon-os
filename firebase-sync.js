...
(function(){
  ...
  var KEYS = ['alizonPrograms','alizonStudents','alizonSubmissions','alizonGrievances',
    ...
    'alizonWorkshops','alizonWorkshopRegs','alizonWsFeedback','alizonPhotos','alizonCurriculum','alizonAllotment','alizonHeroCover'];
  ...
  var AUTH_KEYS = ['alizonStudents','alizonHR','alizonFaculty','alizonResults','alizonContent','alizonExamDocs','alizonNews','alizonWorkshops','alizonWsFeedback','alizonPhotos','alizonPrograms','alizonCurriculum','alizonAllotment','alizonHeroCover'];
