...
(function(){
  ...
  var KEYS = ['alizonPrograms','alizonStudents','alizonSubmissions','alizonGrievances',
    ...
    'alizonWorkshops','alizonWorkshopRegs','alizonWsFeedback','alizonPhotos','alizonCurriculum','alizonAllotment','alizonHeroCover','alizonVacancies','alizonCareerEvents','alizonCareerPay','alizonCareerRegs','alizonLabAccess','alizonExamAttempts','alizonExperience','alizonNotifications','alizonPCC','alizonPvxCases','alizonCertTemplate'];
  ...
  var AUTH_KEYS = ['alizonStudents','alizonHR','alizonFaculty','alizonResults','alizonContent','alizonExamDocs','alizonNews','alizonWorkshops','alizonWsFeedback','alizonPhotos','alizonPrograms','alizonCurriculum','alizonAllotment','alizonHeroCover','alizonVacancies','alizonCareerEvents','alizonCareerPay','alizonCareerRegs','alizonLabAccess','alizonExperience','alizonAttendance','alizonSubmissions','alizonNotifications','alizonPCC','alizonPvxCases','alizonCertTemplate'];
